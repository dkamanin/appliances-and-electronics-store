...
class EventIdTest {
    ...
    class RejectsInvalidInput {
        ...
        void rejectsNullUuid() {
            assertThatThrownBy(() -> new EventId(null))
                    ...
                    .hasMessage("Event identifier must not be null");
        }
        ...
        void rejectsEmptyString() {
            assertThatThrownBy(() -> EventId.of(""))
                    .isInstanceOf(DomainValidationException.class)
                    .hasMessage("Event identifier must not be blank");
        }
        ...
        void rejectsMalformedUuidString() {
            ...
            assertThatThrownBy(() -> EventId.of(malformed))
                    .isInstanceOf(DomainValidationException.class)
    ...
    class CreationFromValidInput {
        ...
        void createsFromValidUuidStringViaFactory() {
            ...
            EventId eventId = EventId.of(uuid.toString());
    ...
    class Generation {
        ...
        @Test
        @DisplayName("should generate valid EventId")
        void generatesValidEventId() {
    ...
    class Equality {
        ...
        void areEqualWhenValuesAreTheSame() {
            ...
            EventId id2 = EventId.of(uuid.toString());
