...
class OrderIdTest {
    ...
    class RejectsInvalidInput {
        ...
        void rejectsNullUuid() {
            assertThatThrownBy(() -> new OrderId(null))
                    ...
                    .hasMessage("Order identifier must not be null");
        }
        ...
        void rejectsEmptyString() {
            assertThatThrownBy(() -> OrderId.of(""))
                    .isInstanceOf(DomainValidationException.class)
                    .hasMessage("Order identifier must not be blank");
        }
        ...
        void rejectsMalformedUuidString() {
            ...
            assertThatThrownBy(() -> OrderId.of(malformed))
                    .isInstanceOf(DomainValidationException.class)
    ...
    class CreationFromValidInput {
        ...
        void createsFromValidUuidStringViaFactory() {
            ...
            OrderId orderId = OrderId.of(uuid.toString());
    ...
    class Generation {
        ...
        @Test
        @DisplayName("should generate valid OrderId")
        void generatesValidOrderId() {
    ...
    class Equality {
        ...
        void areEqualWhenValuesAreTheSame() {
            ...
            OrderId id2 = OrderId.of(uuid.toString());
